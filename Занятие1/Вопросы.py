...
# Занятие 2. д/з.
# (1, 1_3, 1_5 сделаны)/ 3_1, 3_2 сделано, 1_4 - сделано (надо проверить)
# 3_3 - не понимаю, как доделать
# 4_1 сделано - отправил на проверку
#1_2 - сделано, прошу проверить

# Задание к занятию 4. д/з, 1_1 и 1_2
